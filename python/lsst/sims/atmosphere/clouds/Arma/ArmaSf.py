...
Usage:
  ...
  Set up cloud ACF and basic variance, using information about lambda_p / lambda_avg / lambda_s (a.setAcfAndVar()) 
   -- this needs to be done on the timescale of variability for lambda_p / lambda_avg (multiple exposures, ~ per night?)
  Add total cloud extinction and random # 'c' to calculate structure function (angle / SF)  (SFtheta, SFsf = a.CloudSf)
   -- this probably changes every exposure? (certainly kappa does)
...
class ArmaSf():
    ...
    def CloudSf(self, kappa, c):
        """
        Set cloud structure function, for particular kappa / c values. Returns SFtheta and SFsf. 
    ...
    def setAcfAndVar(self, lambda_p, lambda_avg, lambda_s, acfFileName=None, x_max=1000.0):
        """
